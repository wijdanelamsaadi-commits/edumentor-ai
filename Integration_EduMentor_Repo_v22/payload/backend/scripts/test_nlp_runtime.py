...
checks = {
    ...
    "level": predict_level(
        registry,
        "Analysez la portée symbolique de la cellule.",
    ),
    ...
    "adaptation": adapt_text(
        registry,
        source_text=(
            "Le condamné réfléchit aux conséquences sociales "
            "et morales de l’exécution."
        ),
    ...
    "exam": classify_exam_competence(
        registry,
        "Quelle valeur symbolique possède cette cellule ?",
    ),
}
