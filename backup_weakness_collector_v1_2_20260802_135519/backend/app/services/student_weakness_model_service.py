...
COLLECTOR_VERSION = "weakness-event-collector-v1.1-20260802"
...
def canonical_competence(value: Any) -> str | None:
    ...
    if any(token in text for token in (
        "methodologie", "methode", "gestion du temps", "repartir le temps",
        "lire la consigne", "respect de la consigne", "bareme", "brouillon",
